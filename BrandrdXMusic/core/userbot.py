    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("untold_coder4")
                await self.two.join_chat("About_me_pink")
                await self.two.join_chat("moonlight_music4")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("untold_coder4")
                await self.three.join_chat("About_me_pink")
                await self.three.join_chat("moonlight_music4")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("untold_coder4")
                await self.four.join_chat("About_me_pink")
                await self.four.join_chat("moonlight_music4")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("untold_coder4")
                await self.five.join_chat("About_me_pink")
                await self.five.join_chat("moonlight_music4")
            except:
                pass
            assistants.append(5)
            try:
